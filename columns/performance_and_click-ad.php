        ...
        <tbody>
            ...
            <?php
                ...
                if($ads['data']) :
                    ...
                    if(isset($ad_insights['data'])){ $total_clicks+= $ad_insights['data'][0]['clicks'];} 
                    if(isset($ad_insights['data'])){ $total_cpc+= $ad_insights['data'][0]['cpc'];} 
                    if(isset($ad_insights['data'])){ $total_ctr+= $ad_insights['data'][0]['ctr'];} 
                    if(isset($ad_insights['data'])){ $total_total_unique_actions+= $ad_insights['data'][0]['total_unique_actions'];} 

                    if(isset($ad_insights['data'])){ $total_call_to_action_clicks+= $ad_insights['data'][0]['call_to_action_clicks'];} 
                        ...
                        <!--     <td>Ongoing-</td> -->
                            ...
                            <td>
                                <?php if(isset($ad_insights['data'])){echo $ad_insights['data'][0]['call_to_action_clicks'];}else{ echo '-';}?>
                            </td>
                            <td>
                                <?php if(isset($ad_insights['data'])){echo $ad_insights['data'][0]['clicks'];}else{ echo '-';}?>
                            </td>
                            <td>
                                <?php if(isset($ad_insights['data'])){echo $ad_insights['data'][0]['cpc'];}else{ echo '-';}?>
                            </td>
                            <td>
                                <?php if(isset($ad_insights['data'])){echo $ad_insights['data'][0]['ctr'];}else{ echo '-';}?>
                            </td>
                            <td>
                                    ...
                                    foreach($breaks['data'] as $brk): 
                                        ...
                                        <?php if(count($breaks['data'])>1): ?>      
                                         <tr class="ad_rows" >
                                            ...
                                            <td> <?php echo @$brk['call_to_action_clicks']; ?> </td>
                                            </td> <?php echo @$brk['clicks']; ?> </td>
                                            <td> <?php echo @$brk['cpc']; ?> </td>
                                            <td> <?php echo @$brk['ctr']; ?> </td>
                ...
                <tr>
                  ...
                  <!--   <td>-<span>Per People</span>
                    ...
                    <td><?php if($total_unq_click) { echo $total_unq_click; } else { echo '—Total'; } ?></td>
                     <td><?php if($total_call_to_action_clicks) { echo $call_to_action_clicks; } else { echo '—Total'; } ?></td>
