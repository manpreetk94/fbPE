...
<table class="table table-bordered table-inverse table-striped table-hover" id="camapaign_table">
	    ...
	    <tbody id="camapaign_listing">
	        ...
	        <tr class="camp_rows" id="<?php echo $camapaign['id'];?>">
	            ...
	            <td>
	               <?php
	                ...
	                echo $type = '<p>'.str_replace('_',' ', ucfirst($camapaign['objective_for_results'])).'</p>'; 
	                ?>
	            </td>
	            <td>
	        ...
	        <tr>
	            ...
	            <td></td>
	            <td><?php if($total_inline_link_clicks) { //echo $total_inline_link_clicks; } else { echo 'Link Click'; 
	            } ?></td>
