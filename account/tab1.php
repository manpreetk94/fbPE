...
if($( ".tab1" ).width()==100){
	...
	var chart = new CanvasJS.Chart("chartContainerAccountTab1", {
...
<?php if(!empty($account_graph['data'])){ ?>
		...
		<div id="chartContainerAccountTab1" style="height: 420px; width: 100%;float:left;"></div> 
