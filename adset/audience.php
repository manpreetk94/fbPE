...
<div class="row" style="margin-top:5px;">
	<div class="col-md-5"><label> SAVED AUDIENCE </label></div>
	<div class="col-md-6" id="apd_saved_audience">		
		<select class="selectpicker show-tick" data-size="3" id="saved_aud" name="saved_aud">	
			<option  value="" class="">New Audience</option>
		</select>							
	</div>
</div>
...
<div class="white-block-body custom_audience">
	<form id="audience_form" method="post">
		<div class="row">
			<div class="col-md-5"><label>Custom Audiences </label></div>
			<div class="col-md-6 custm_aud_slct">
				<br>
				<a href="#" class="exl_cust_aud">Exclude</a> 
			</div>
		</div>
		<div class="row">
		...
		<div class="row">
			<div class="col-md-5"><label>Age </label></div>
			<div class="col-md-6">
		...
		<div class="row gender">
			<div class="col-md-5"><label style="border: 0">Gender </label></div>
			<div class="col-md-6 r">
				<div class="all-gen target_gender" rel="All">
					<input type="radio" name="target_gender" id="All" class="radio"  value="" />
		...
		<div class="row">
			<div class="col-md-5"><label>Languages </label></div>
			<div class="col-md-6">
				<div class="detail-locale-slctd" style="display:none;">
						
				</div>
				<input type="text" name="adset_language" placeholder="Type a language" class="form-control detail-locale-field" id="target_language">
				<div class="detail-locale-list">
		...
		<div class="row">
			<div class="col-md-5"><label>Detailed Targeting </label></div>
			<div class="col-md-7">
				<div class="radio margin-top-zero">
					<label style="padding: 0">INCLUDE people who match at least ONE of the following </label><br>

					<div class="detail-target-slctd" style="display:none;">
						
					</div>
					<input class="form-control detail-target-field" type="text" placeholder="Type Demographics ,Interests and Behaviours">
